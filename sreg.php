<?php
    ...
    if(isset($_POST['ssignupreg'])){
        $username = $_POST['username'];
        $phonenumber = $_POST['phonenumber'];
        $rollnumber = $_POST['rollnumber'];
        $password = $_POST['password'];
        $sql = "INSERT INTO `sreg`(`username`, `phonenumber`, `rollnumber`,`password`) VALUES ('$username','$phonenumber','$rollnumber','$password');";
...
<body>
        ...
        <h1>Student Registration</h1>
            ...
            <form action="sreg.php" method="post">
                ...
                <input type="submit" name="ssignupreg" class="btn" value="Sign Up">
                <a href="slogin.php">Sign In</a>
